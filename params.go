...
func NewPublicParameter(paramN int, paramI int, paramJ int, paramD int, paramDInv int32, paramQ uint32, paramZeta int32, paramK int,paramKInv int32,paramSigmaPermutations [][]int,paramSigmaInvPermutations [][]int, paramKa int, paramLa int, paramEtaA int32, paramBetaA int32, paramKc int, paramLc int, paramEtaC int32, paramBetaC int32, paramEtaC2 int32, paramBetaC2 int32, paramMa int, paramEtaF int32, paramKem *kyber.ParameterSet) (*PublicParameter, error) {
	res := &PublicParameter{paramN: paramN, paramI: paramI, paramJ: paramJ, paramD: paramD, paramDInv: paramDInv, paramQ: paramQ, paramZeta: paramZeta, paramK: paramK,paramKInv:paramKInv,paramSigmaPermutations:paramSigmaPermutations,paramSigmaInvPermutations:paramSigmaInvPermutations, paramKa: paramKa, paramLa: paramLa, paramEtaA: paramEtaA, paramBetaA: paramBetaA, paramKc: paramKc, paramLc: paramLc, paramEtaC: paramEtaC, paramBetaC: paramBetaC, paramEtaC2: paramEtaC2, paramBetaC2: paramBetaC2, paramMa: paramMa, paramEtaF: paramEtaF, paramKem: paramKem}
...
func init() {
	...
	DefaultPP, err = NewPublicParameter(
		...
		[][]int{
			...
			{
				65, 195, 69, 199, 73, 203, 77, 207, 81, 211, 85, 215, 89, 219, 93, 223,
				97, 227, 101, 231, 105, 235, 109, 239, 113, 243, 117, 247, 121, 251, 125, 255,
				129, 3, 133, 7, 137, 11, 141, 15, 145, 19, 149, 23, 153, 27, 157, 31,
				161, 35, 165, 39, 169, 43, 173, 47, 177, 51, 181, 55, 185, 59, 189, 63,
				193, 67, 197, 71, 201, 75, 205, 79, 209, 83, 213, 87, 217, 91, 221, 95,
				225, 99, 229, 103, 233, 107, 237, 111, 241, 115, 245, 119, 249, 123, 253, 127,
				1, 131, 5, 135, 9, 139, 13, 143, 17, 147, 21, 151, 25, 155, 29, 159,
				33, 163, 37, 167, 41, 171, 45, 175, 49, 179, 53, 183, 57, 187, 61, 191,
		...
		[][]int{
			...
			{
				191, 61, 187, 57, 183, 53, 179, 49, 175, 45, 171, 41, 167, 37, 163, 33,
				159, 29, 155, 25, 151, 21, 147, 17, 143, 13, 139, 9, 135, 5, 131, 1,
				127, 253, 123, 249, 119, 245, 115, 241, 111, 237, 107, 233, 103, 229, 99, 225,
				95, 221, 91, 217, 87, 213, 83, 209, 79, 205, 75, 201, 71, 197, 67, 193,
				63, 189, 59, 185, 55, 181, 51, 177, 47, 173, 43, 169, 39, 165, 35, 161,
				31, 157, 27, 153, 23, 149, 19, 145, 15, 141, 11, 137, 7, 133, 3, 129,
				255, 125, 251, 121, 247, 117, 243, 113, 239, 109, 235, 105, 231, 101, 227, 97,
				223, 93, 219, 89, 215, 85, 211, 81, 207, 77, 203, 73, 199, 69, 195, 65,
			},
			{
				129, 131, 133, 135, 137, 139, 141, 143, 145, 147, 149, 151, 153, 155, 157, 159,
				161, 163, 165, 167, 169, 171, 173, 175, 177, 179, 181, 183, 185, 187, 189, 191,
